...
GRACE_NETCDF_NAME = "GRCTellus.JPL.200204_202604.GLO.RL06.3M.MSCNv04.nc"
ERA5_NETCDF_NAME = "era5.nc"
ERA5_BASIN_MONTH_CSV = DATA_PROCESSED / f"basin_month_era5_{EXPERIMENT_REGION}.csv"
ERA5_BASIN_MONTH_PROVENANCE_JSON = DATA_PROCESSED / f"basin_month_era5_{EXPERIMENT_REGION}.provenance.json"
LAGGED_GRACE_ERA5_DATASET_CSV = DATA_PROCESSED / f"lagged_grace_era5_dataset_{EXPERIMENT_REGION}.csv"
LAGGED_GRACE_ERA5_DATASET_PROVENANCE_JSON = (
    DATA_PROCESSED / f"lagged_grace_era5_dataset_{EXPERIMENT_REGION}.provenance.json"
)
